...
CEE_weight = 0.4  # 0.3  # Cross_entropy error weightage
v_error_weight = 0.6  # 0.4  # validation error weightage
arch_penalty_weight = 0  # 0.2  # architecture penalty weightage
feature_penalty_weight = 0  # 0.1  # feature penalty weightage
